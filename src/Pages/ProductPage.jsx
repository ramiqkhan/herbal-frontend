...
const ProductPage = () => {
  ...
  const handleAddToCart = () => {
    ...
    alert(`${quantity}x ${product.name} (${selectedSize?.label || 'Standard Size'}) added to cart at Rs. ${finalPrice.toLocaleString('en-PK')} each!`);
  };
    ...
    <section className="max-w-[1200px] mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-6 space-y-6 lg:sticky lg:top-28">
          ...
          {/* QUANTITY AND TRANSACTION INTERACTION LAYER */}
